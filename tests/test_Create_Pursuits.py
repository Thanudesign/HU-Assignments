...
def test_Create_Pursuits(login):
     ...
     expect(create_pursuits.txt_Country_Value).to_have_text("India")
     expect(create_pursuits.txt_Proposal_Type_Value).to_have_text("RFI")
     expect(create_pursuits.txt_Type_of_Project_Value).to_have_text("Test Automation")
     expect(create_pursuits.txt_Billing_Arrangement_Value).to_have_text("Fixed Fee")
